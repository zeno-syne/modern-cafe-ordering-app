...
> **Tester Focus:** Usability, Cart & Checkout, QR Dine-in, Edge Cases, Real Devices Only  
...
- [ ] **Escape Key Modal Dismiss:** Buka modal pemesanan menu atau Cart Drawer, lalu tekan tombol `Escape` di keyboard. Pastikan modal tertutup seketika.

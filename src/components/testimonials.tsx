...
export default function Testimonials() {
  return (
    <section id="ulasan" className="py-24 md:py-32 relative bg-[#14110E] border-t border-stone-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3.5 mb-16">
          ...
          <div className="pt-3 inline-flex items-center gap-3 px-5 py-2 rounded-full bg-[#1C1612] border border-stone-800 shadow-md">
            <div className="flex items-center gap-1">
              {[...Array(5)].map((_, i) => (
                <Star key={i} className="w-4 h-4 fill-amber-400 text-amber-400" />
              ))}
            </div>
            <span className="text-white font-extrabold text-sm font-display">4.9 / 5.0</span>
            <span className="text-stone-400 text-xs">(180+ Ulasan Google Maps)</span>
          </div>
        </div>

        {/* Double-Bezel Google Maps Review Cards Grid */}
              ...
              <div className="bezel-core">
                <div>
                  ...
                  <div className="flex items-center gap-3 mb-3.5">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#EA580C] to-[#C2410C] text-white font-black flex items-center justify-center text-sm shadow-md">
                      {rev.name.charAt(0)}
                    </div>
                    <div>
